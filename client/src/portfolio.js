...
import Random_Chord_Generator from './img/Random_Chord_Generator.png';
    ...
    return (
      <div>
        <div id="projects-div">
          ...
          <Project title="Bible API" href="https://glitch.com/edit/#!/functional-pancreas?path=server.js:1:0" src={bible_api} preview="https://functional-pancreas.glitch.me/" description='This was an attempt to make a searchable API for finding bible verses. I converted a text document into JSON format using regular expressions.'/>          
          <Project title="Random Chord Generator" href="https://github.com/seely1991/random-chord-generator" src={Random_Chord_Generator} description="A random chord/note generator useful for practicing scales, chords, or improvisational sightreading." />
